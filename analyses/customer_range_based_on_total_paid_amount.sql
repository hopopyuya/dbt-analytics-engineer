with
    ...
    total_amount_per_customer_on_orders_complete as (
        select
            cust.customer_id, cust.first_name, sum(total_amount) as global_paid_amount
...
select tac.customer_id, tac.first_name, tac.global_paid_amount, crp.classification
